#include "../Header/CBlurVPass.h"

bool CBlurVPass::Initialize(CDevice& device, Size size, Color* clearColor, CScreenAlignedQuad* SAQ,
...
#ifdef DIRECT_X
	m_dataCB.Initialize(sizeof(BlurVData));
#endif
#ifdef OPEN_GL
...
void CBlurVPass::Render(CDeviceContext& deviceContext)
{
#ifdef OPEN_GL
...
void CBlurVPass::Clear(CDeviceContext& deviceContext)
{
	deviceContext.ClearColor(m_renderTarget, *m_clearColor);
}

void CBlurVPass::Set(CDeviceContext& deviceContext)
{
	//Generate mipmaps
	...
	deviceContext.UpdateBlurVData(m_dataCB, m_screenAlignedQuad->m_blurVData);

	//Set Render Target
	deviceContext.SetRenderTarget(m_renderTarget, nullptr);
}

bool CBlurVPass::Resize(CDevice& device, Size size)
{
#ifdef DIRECT_X
	HRESULT result;
...
void CBlurVPass::Update()
{

}

void CBlurVPass::Erase()
{

}

CBlurVPass::CBlurVPass()
{
#ifdef DIRECT_X
