#include "../Header/CLuminancePass.h"

bool CLuminancePass::Initialize(CDevice& device, Size size, Color* clearColor, CScreenAlignedQuad* SAQ, 
...
void CLuminancePass::Render(CDeviceContext& deviceContext)
{
#ifdef OPEN_GL
...
void CLuminancePass::Clear(CDeviceContext& deviceContext)
{
	deviceContext.ClearColor(m_renderTarget, *m_clearColor);
}

void CLuminancePass::Set(CDeviceContext& deviceContext)
{
	//Generate mipmaps
...
bool CLuminancePass::Resize(CDevice& device, Size size)
{
#ifdef DIRECT_X
	HRESULT result;
...
void CLuminancePass::Update() {

}

void CLuminancePass::Erase() {

}

CLuminancePass::CLuminancePass() {
#ifdef DIRECT_X
