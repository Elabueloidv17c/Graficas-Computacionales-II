...
void CManager::Initialize(Rect dimensions)
{
	...
	scene.push_back(ModelData{ "../Dragon/Dragon.fbx", glm::translate(MATRIX4(1.0f), VECTOR3(150.0f, 0.0f, 0.0f)) });
	scene.push_back(ModelData{ "../Anubis/Anubis.fbx", glm::mat4(1.0f) });
	scene.push_back(ModelData{ "../Quad/Plane.fbx", glm::rotate(glm::scale(glm::translate(MATRIX4(1.0f), VECTOR3(-150.0f, 0.0f, 0.0f)),
	VECTOR3(8.f, 4.5f, 8.f)), glm::radians(180.0f), VECTOR3(0.0f, 1.0f, 0.0f)) });
...
void CManager::Initialize(WNDPROC pWndProc, HINSTANCE hInstance, std::string title, std::string className, Size size, Color color, INT nCmdShow)
{
	...
	scene.push_back(ModelData{ "../Anubis/Anubis.fbx", glm::mat4(1.0f) });
	scene.push_back(ModelData{ "../Quad/Plane.fbx", glm::rotate(glm::scale(glm::translate(MATRIX4(1.0f), VECTOR3(-150.0f, 0.0f, 0.0f)),
	VECTOR3(8.f, 4.5f, 8.f)), glm::radians(180.0f), VECTOR3(0.0f, 0.0f, 1.0f)) });
...
void CManager::Render()
{
	...
	m_window.m_scene.m_models[3].m_meshes[0].m_texture.m_id = m_renderTexture.m_idTexture;
	...
	m_window.m_scene.m_models[3].m_meshes[0].m_texture = m_renderTexture.m_shaderResource;
